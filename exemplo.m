...
clearvars
visaObj = instrfind('Type', 'visa-usb', 'RsrcName', 'USB0::0x0957::0x1799::MY52163581::0::INSTR', 'Tag', '');
if isempty(visaObj)
    visaObj = visa('NI', 'USB0::0x0957::0x1799::MY52163581::0::INSTR');
    visaObj.OutputBufferSize = 99999999;
    visaObj.InputBufferSize = 99999999;
    visaObj.timeout=10;
    fopen(visaObj);
end
...
fprintf(visaObj,':ACQUIRE:COUNT 1'); % Tomar wfm uma vez
